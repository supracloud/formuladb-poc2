...
<ul class="nav flex-row pl-1">
    ...
    <li class="nav-item dropdown flex-grow-1">
        <input id="table-list" type="checkbox" />
        <label for="table-list" class="nav-link dropdown-toggle text-primary text-center" href="javascript:void(0)" aria-haspopup="true" aria-expanded="false"
    ...
    <li class="nav-item dropdown">
        <input id="table-opts" type="checkbox" />
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="table-options">
            <a class="dropdown-item" id="new-table-btn" title="New Table"><i class="fa fa-plus-circle"></i> New Table</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" id="delete-table-btn" title="Delete Table" data-frmdb-prop="tableToDelete::$frmdb.selectedTableId"><i
                    class="fa fa-trash"></i> Delete <span data-frmdb-value="$frmdb.selectedTableId"></span></a>
        </div>
    </li>
</ul>
