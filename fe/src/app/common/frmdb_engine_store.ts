...
import { MapReduceTrigger, CompiledFormula, MapFunctionT } from "@storage/domain/metadata/execution_plan";
...
import { ReduceFun, SumReduceFunN, TextjoinReduceFunN, CountReduceFunN } from "@storage/domain/metadata/reduce_functions";
