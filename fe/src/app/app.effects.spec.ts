...
xdescribe('AppEffects', () => {
    ...
    beforeEach(() => {
        ...
        actorTestId = mainDemoFlow.mockData.getAllForPath(GEN__Actor._id)[0]._id;
    });
    ...
    it('a router effect test', () => {
            let values = {
                a: {
                    ...
                    payload: {routerState: {url: '/GEN__Actor'}} as RouterNavigationPayload<appState.RouterState>
                } as RouterNavigationAction<appState.RouterState>,
                b: {
                    type: ROUTER_NAVIGATION,
                    payload: {routerState: {
                        url: '/GEN__Actor/' + actorTestId
                    }} as RouterNavigationPayload<appState.RouterState>
                } as RouterNavigationAction<appState.RouterState>,
                c: {
                    type: ROUTER_NAVIGATION,
                    payload: {routerState: {url: '/GEN__Currency'}} as RouterNavigationPayload<appState.RouterState>
                } as RouterNavigationAction<appState.RouterState>,
                m: new fromTable.TableFormBackendAction(getDefaultTable(GEN__Actor as Entity)),
                n: new fromTable.TableDataFromBackendAction(
                    mainDemoFlow.mockData.getAllForPath(GEN__Actor._id).map(o => new ChangeObj(o))),
                o: new fromForm.FormFromBackendAction(getDefaultForm(GEN__Actor as Entity, mainDemoFlow.mockMetadata.schema.entities)),
                p: new fromForm.FormDataFromBackendAction(mainDemoFlow.mockData.get(GEN__Actor._id, actorTestId)),
                q: new fromTable.TableFormBackendAction(getDefaultTable(GEN__Currency as Entity)),
                r: new fromTable.TableDataFromBackendAction(
                    mainDemoFlow.mockData.getAllForPath(GEN__Currency._id).map(o => new ChangeObj(o))),
                s: new fromForm.FormFromBackendAction(getDefaultForm(GEN__Currency as Entity, mainDemoFlow.mockMetadata.schema.entities)),
            }
