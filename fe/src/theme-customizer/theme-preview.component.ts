            ...
            <div class="card-deck">
                <div class="card frmdb-t-card-img" style="display: grid;">
                    <div class="frmdb-t-img overflow-hidden">
                        <img src="/formuladb-env/static/frmdb-apps/base-app/card1.jpg" alt="" />
                    </div>
                    <div class="card-body">
                        <h5>Card 1 title</h5>
                ...
                <div class="card frmdb-t-card-img">
                    <div class="frmdb-t-img overflow-hidden">
                        <img src="/formuladb-env/static/frmdb-apps/base-app/card2.jpg" alt="">
                    </div>
                    <div class="card-body">
                        <h5>Card 2 title</h5>
                ...
                <div class="card frmdb-t-card-img">
                    <div class="frmdb-t-img overflow-hidden">
                        <img src="/formuladb-env/static/frmdb-apps/base-app/card3.jpg" alt="">
                    </div>
                    <div class="card-body">
                        <h5>Card 3 title</h5>
                ...
                <div class="card frmdb-t-card-img">
                    <div class="frmdb-t-img overflow-hidden">
                        <img src="/formuladb-env/static/frmdb-apps/base-app/card4.jpg" alt="">
                    </div>
                    <div class="card-body">
                        <h5>Card 4 title</h5>
