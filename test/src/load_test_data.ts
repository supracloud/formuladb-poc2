...
//             let frmdbEngineStore = new FrmdbEngineStore(schemaForApp.appName, kvsFactory, schemaForApp.schema);
//             await frmdbEngineStore.kvsFactory.metadataStore.putApp(schemaForApp.appName, schemaForApp.app);
//             await frmdbEngineStore.kvsFactory.metadataStore.putSchema(schemaForApp.appName, schemaForApp.schema);
