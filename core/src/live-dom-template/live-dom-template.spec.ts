...
import { updateDOMForDoc } from "./live-dom-template";
...
<div data-frmdb-table="tableName[]" data-frmdb-attr="class[row1|row2]::tableName[].name">
    ...
    <ul data-frmdb-attr="style.background-color::tableName[].bg">
        <li data-frmdb-attr="my-attr::tableName[].atr" data-frmdb-value="::tableName[].name"></li>
        <li data-frmdb-attr="class.my-class::tableName[].cls" data-frmdb-value="::tableName[].description" data-frmdb-attr2="class[row1|row2]::tableName[].name"></li>
    </ul>
...
describe('[FE] FrmdbTemplate', () => {
    ...
    it('should update view when template OR data changes', () => {
        let el = htmlTools.wrapHTML(template);
        updateDOMForDoc(htmlTools.doc, data, el)
            ...
            <div>
                ...
                <div data-frmdb-table="tableName[]" data-frmdb-attr="class[row1|row2]::tableName[].name" class="row1">
                    ...
                    <ul data-frmdb-attr="style.background-color::tableName[].bg" style="background-color: red;">
                        <li data-frmdb-attr="my-attr::tableName[].atr" data-frmdb-value="::tableName[].name" my-attr="attr1">row1</li>
                        <li data-frmdb-attr="class.my-class::tableName[].cls" data-frmdb-value="::tableName[].description"  data-frmdb-attr2="class[row1|row2]::tableName[].name" class="row1 my-class">desc of row 1</li>
                    </ul>
                    <h1 data-frmdb-prop="complex::tableName[].childTable"></h1>
                </div>
                <div data-frmdb-table="tableName[]" data-frmdb-attr="class[row1|row2]::tableName[].name" class="row2">
                    ...
                    <ul data-frmdb-attr="style.background-color::tableName[].bg" style="background-color: blue;">
                        <li data-frmdb-attr="my-attr::tableName[].atr" data-frmdb-value="::tableName[].name" my-attr="attr2">row2</li>
                        <li data-frmdb-attr="class.my-class::tableName[].cls" data-frmdb-value="::tableName[].description" data-frmdb-attr2="class[row1|row2]::tableName[].name" class="row2">desc of row 2</li>
                    </ul>
                    <h1 data-frmdb-prop="complex::tableName[].childTable"></h1>
                </div>
            </div> 
    ...
    it('should support binding to async functions', async (done) => {
        let el = htmlTools.wrapHTML(/*html*/`
            <a data-frmdb-table="asyncFunc[]" data-frmdb-value="asyncFunc[]"></a>
        `);
        updateDOMForDoc(htmlTools.doc, {asyncFunc: () => fakeAsync([1, 2, 3, 4])}, el);
