...
} else if (shell.exec('docker run -d --name formuladb-pg -p 5432:5432 --mount source=pg_data,target=/var/lib/postgresql/data -e \'POSTGRES_PASSWORD=p@ssw0rd42\' postgres:latest').code !== 0) {
