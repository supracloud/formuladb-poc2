...
export const _$App = {
    ...
    props: {
        ...
        defaultLook: { name: "defaultLook", propType_: Pn.TEXT } as EntityProperty,
        defaultPrimaryColor: { name: "defaultPrimaryColor", propType_: Pn.TEXT } as EntityProperty,
        defaultSecondaryColor: { name: "defaultSecondaryColor", propType_: Pn.TEXT } as EntityProperty,
        defaultTheme: { name: "defaultTheme", propType_: Pn.TEXT } as EntityProperty,
    }
};
...
export const _$FrmdbEnv = {
    ...
    props: {
        _id: { name: "_id", propType_: Pn.TEXT, required: true } as EntityProperty,
        default_app_name: { name: "default_app_name", propType_: Pn.TEXT, required: true } as EntityProperty,
...
export const _$User = {
    ...
    props: {
        _id: { name: "_id", propType_: Pn.TEXT, required: true } as EntityProperty,
        role: { name: "role", propType_: Pn.TEXT, required: true } as EntityProperty,
...
export const _$Permission = {
    ...
    props: {
        ...
        app_name: { name: "app_name", propType_: Pn.TEXT, required: true } as EntityProperty,
        resource_entity_id: { name: "resource_entity_id", propType_: Pn.TEXT, required: true } as EntityProperty,
        resource_id: { name: "resource_id", propType_: Pn.TEXT } as EntityProperty,
        permission: { name: "permission", propType_: Pn.TEXT, enumValues: ["READ", "WRITE", "DELETE"]} as EntityProperty,
        for_who: { name: "for_who", propType_: Pn.TEXT, enumValues: ["OWNER", "ROLE", "ALL"]} as EntityProperty,
        details: { name: "details", propType_: Pn.TEXT } as EntityProperty,
    }
};
...
export const _$System_Param = {
    ...
    props: {
        _id: { name: "_id", propType_: Pn.KEY, scalarFormula: "name" } as EntityProperty,
        name: { name: "name", propType_: Pn.TEXT, required: true } as EntityProperty,
        value: { name: "value", propType_: Pn.TEXT, required: true } as EntityProperty,
    }
};
...
const _$Dictionary = {
    ...
    props: {
        _id: { name: "_id", propType_: Pn.TEXT, required: true } as EntityProperty,
        gb: { name: "gb", propType_: Pn.TEXT } as EntityProperty,
        fr: { name: "fr", propType_: Pn.TEXT } as EntityProperty,
        de: { name: "de", propType_: Pn.TEXT } as EntityProperty,
        it: { name: "it", propType_: Pn.TEXT } as EntityProperty,
        es: { name: "es", propType_: Pn.TEXT } as EntityProperty,
        pt: { name: "pl", propType_: Pn.TEXT } as EntityProperty,
        gr: { name: "el", propType_: Pn.TEXT } as EntityProperty,
        ro: { name: "ro", propType_: Pn.TEXT } as EntityProperty,
        bg: { name: "bg", propType_: Pn.TEXT } as EntityProperty,
        da: { name: "da", propType_: Pn.TEXT } as EntityProperty,
        sv: { name: "sv", propType_: Pn.TEXT } as EntityProperty,
        no: { name: "no", propType_: Pn.TEXT } as EntityProperty,
        nl: { name: "nl", propType_: Pn.TEXT } as EntityProperty,
    }
};
