...
describe('base_obj', () => {
    ...
    it('should get object properties from deep path', () => {
        let props = queryObjectWithDeepPath({ _id: "1", a: 1, b: 2, c: { _id: '1.1', c1: { _id: '1.1.1', c1prop: 123 } } }, 'Inventory_Product/c/c1');
        expect(props).toEqual({ ref_: 'Inventory_Product/1/c/c1', c1prop: 123 });
        ...
        }, 'Inventory_Product/c/c1/1');
        expect(props).toEqual({ ref_: 'Inventory_Product/1/c/c1/1.1.2', c1prop: 456 });
        ...
        }, 'Inventory_Product/c/c1/1.1.3');
        expect(props).toEqual({ ref_: 'Inventory_Product/1/c/c1/1.1.3', c1prop: 789 });
    });
